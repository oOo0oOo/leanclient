...
def test_multiple_files_async(lsp_client: LeanLSPClient):
    ...
    paths = ["LeanTestProject/Basic.lean", "LeanTestProject/Basic.lean"]  # Same file for simplicity
...
def test_notification_handler_registration(lsp_client: LeanLSPClient):
    ...
    lsp_client._register_notification_handler("textDocument/publishDiagnostics", handler)
